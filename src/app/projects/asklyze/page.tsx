...
export default function AsklyzePage() {
  ...
  useEffect(() => {
    return pipelineProgress.onChange((latest) => {
      // Calculate active step based on progress (0 to 1)
  ...
  return (
    <div ref={containerRef} className="relative bg-[#06080a] text-white min-h-screen selection:bg-sinai-glow-orange selection:text-black font-sans">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-[9px] uppercase tracking-[0.5em] text-sinai-glow-orange font-bold">
                    ORACLE_APEX_INTELLIGENCE // PLUGIN_01
                  </span>
                </div>
                ...
                <p className="text-xl md:text-2xl text-zinc-400 max-w-xl font-light leading-relaxed">
                  The first native Oracle APEX plugin that transforms complex data into conversational intelligence without moving a single byte of data.
                </p>
              </div>
      ...
      {/* Neural Capability Hub - Super Premium Redesign */}
      ...
      {/* The Intelligence Pipeline // 04 - SCROLL-DRIVEN INTERACTIVE WALKTHROUGH */}
      <section id="pipeline-scroll" className="relative bg-[#06080a]">
        {/* Height = Number of steps * 100vh */}
          ...
          <div className="sticky top-0 h-screen w-full flex items-center overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center z-30">
                      <div className="relative w-full h-full">
                        ...
                        <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-20">
                          ...
                          />
                          <defs>
                            <linearGradient id="glow-grad-restore" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                {/* Right: Vertical List Steps - Restored Original Design */}
      ...
      {/* Final CTA Section - Cinematic Masterpiece - EXACT REPLICA FROM SERVICES */}
      <section className="py-64 relative overflow-hidden bg-[#06080a]">
        ...
        <div className="absolute bottom-12 right-12 text-[8px] font-mono text-zinc-800 tracking-widest hidden lg:block uppercase">
          Apex_Experts_Engineering_Studio<br />
          System_Build_Hash: 0xPR_ASKLYZE
        </div>
      </section>
