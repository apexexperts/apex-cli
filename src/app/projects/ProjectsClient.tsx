...
const PROJECTS = [
  {
    ...
    detailedDesc: "Asklyze is engineered specifically for the Oracle APEX ecosystem. It allows users to query complex schemas using natural language, translating intent into secure PL/SQL natively.",
    image: "/images/asklyze-premium.png",
    tags: ["Oracle APEX", "AI Plugin", "PL/SQL"],
    icon: <Terminal className="w-8 h-8" />,
    specs: { status: "PRODUCTION", deployment: "ORACLE_CLOUD", build: "0x7F41" }
  },
  {
    id: "02",
    slug: "myquery",
